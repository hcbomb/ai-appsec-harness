...
10. Attest
   - Generate an attestation package that states scope, evidence, gaps, exceptions, compensating controls, and residual risk when human-reviewed attestation is requested.
